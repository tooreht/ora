...
# Add and remove not implemented yet!

defmodule OraWeb.InputHelpers do
  use Phoenix.HTML

  def array_input(form, field, default) do
    values = Phoenix.HTML.Form.input_value(form, field) || default
